...
import {
  ...
  deleteThemePackage,
  updateThemePackage,
} from "../../../repository/ThemeRepo";

const PackageListing = ({ data, themeName }) => {
  ...
  const handleDelete = async (id) => {
    try {
      await deleteThemePackage(themeName, id);
  ...
  const handleSubmit = async () => {
    try {
      ...
      if (isEditMode && currentPackage) {
        await updateThemePackage(themeName, currentPackage.id, formattedValues);
        setPackages((prev) =>
          prev.map((pkg) =>
        ...
        const docRef = await addThemePackage(themeName, formattedValues);
