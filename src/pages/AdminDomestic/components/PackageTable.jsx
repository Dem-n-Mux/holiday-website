...
import {
  addDomesticPlacePackage,
  deleteDomesticPlacePackage,
  updateDomesticPlacePackage,
...
const PackageTable = ({ data, regionId, placeId, docId }) => {
  ...
  const handleDelete = async (id) => {
    try {
      await deleteDomesticPlacePackage(id, regionId, placeId, docId);
  ...
  const handleSubmit = async () => {
    try {
      ...
      if (isEditMode && currentPackage) {
        await updateDomesticPlacePackage(
          currentPackage.id,
          regionId,
          placeId,
          docId,
        ...
        const docRef = await addDomesticPlacePackage(
          regionId,
          placeId,
          docId,
          formattedValues
